    ...
    var box = $("#box"), 
        ...
        c = {
            ...
            initEvent: function() {
                ...
                box.on(eventName, "span", function() {          //完成一次点击后重复事件
            ...
            tick: function() {              //游戏结束判断
                if (this._pause) {
                    ...
                    if(this.time < 0||this.lv==4){//第一次改动
                        this.gameOver()
                    }
                    else{
            ...
            gameOver: function() {
                ...
                b.d_content.hide(); 
                b.d_disapper.hide();
                if (this.lv==4&&this.time>0) 
                {    //如果完成，隐藏重新开始按钮
                   b.d_disapper.show();//lianxi
                    b.start.hide();
                }
                if(this.time<1&&this.lv<4)
                {
                    b.start.show();
                    b.d_disapper.hide();
                }
                ...
                box.find("span").fadeOut(100, function() {
                    b.dialog.show()
                });
                if ( "color2" == this.type) {
            ...
            nextLv: function() {
                this.time += this.config.addTime;  //奖励时间
                b.time.text(parseInt(this.time)); 
                if(!this._pause)
                    this.start();
            }
